...
import com.example.bat.databinding.FragmentBerandaBinding
...
class BerandaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnBeliBabi.setOnClickListener {
            val intent = Intent(context, BuatPesananBabiActivity::class.java)
            startActivity(intent)
        }

        binding.btnBeliAyam.setOnClickListener {
            val intent2 = Intent(context, BuatPesananAyamActivity::class.java)
            startActivity(intent2)
        }

        binding.btnBeliTelur.setOnClickListener {
            val intent3 = Intent(context, BuatPesananTelurActivity::class.java)
